...
<body>
					...
					<tr align="center">
						...
						<c:choose>
							<c:when test='${article.level > 1}'>
								...
								<a href="${contextPath}/board2/viewArticle.do?articleNO=${article.articleNO}">${article.title}</a>
							</c:when>
							<c:otherwise>
	...
	<a class="cls1" href="${contextPath}/board2/articleForm.do"><p class="cls2">글쓰기</p></a> <!--get 방식-->
</body>
</html>