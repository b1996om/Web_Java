<%@ page language="java" contentType="text/html; charset=UTF-8"
    import="java.util.*, sec01.ex02.*" pageEncoding="UTF-8"%>
<%
	request.setCharacterEncoding("utf-8");  /* useBean에 속성 값을 설정하기 전에 한글인코딩 작업하기. */
%>
...
<%
	/*--> 자바코드를 이용해 빈에 설정할 필요가 없다.(member2에 사용한 코드)
